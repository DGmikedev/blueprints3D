import{ Scene, Engine, Vector3, FreeCamera, HemisphericLight, 
       MeshBuilder, CubeTexture, PBRBaseMaterial, PBRMaterial, 
       Texture } from "@babylonjs/core";

export class MaterialsPBR{
    ...
    createMgicMaterial():PBRMaterial{
        
        const pbr = new PBRMaterial("pbr", this.scene);
        pbr.albedoTexture = new Texture("./textures/metal/metal_ao.jpg");
        pbr.bumpTexture = new Texture("./textures/metal/normal_map_metal.jpg");
pbr.roughness = 1;
        pbr.useAmbientOcclusionFromMetallicTextureRed = true;
        pbr.useRoughnessFromMetallicTextureGreen = true;
        pbr.useMetallnessFromMetallicTextureBlue = true;
        pbr.bumpTexture = new Texture("./textures/metal/metal_ao.jpg");
        pbr.invertNormalMapX = true
        pbr.invertNormalMapY = true
        return pbr;
